<div>
    <form wire:submit.prevent="save" novalidate>
        ...
        <div class="alert alert-info">
            <strong>(:) İki nokta ile başlayan kelimeler çeviri yapılmadan yazılmalıdır. Orjinal metinde ":(kelime)" yazan metin varsa çeviri metninde (:) iki noktalı kelime orjinal olarak yazılmalıdır!</strong>
            <br>

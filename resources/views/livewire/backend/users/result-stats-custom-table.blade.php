<div>
    ...
    @if($showResults)
        ...
        @if($resultType == 'topics')
            <div class="table-responsive">
                <div class="text-start">
                    <button type="button" class="btn btn-success px-4 mb-3" wire:click="exportTopics" wire:loading.attr="disabled">
                        <div wire:loading.remove>
        ...
        @if($resultType == 'exams')
            <div class="table-responsive">
                <div class="text-start">
                    <button type="button" class="btn btn-success px-4 mb-3" wire:click="exportExams" wire:loading.attr="disabled">
                        <div wire:loading.remove>
                            <i class="fa fa-fw fa-file-excel me-1"></i> {{ __('Excele Aktar') }}
                        </div>
                        <div wire:loading>
